...
public class UserData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_of_user);

        name = findViewById(R.id.name);
        email = findViewById(R.id.email);
        accountNo = findViewById(R.id.accNo);
        balance = findViewById(R.id.currBalance);
        ifscCode = findViewById(R.id.ifsc_id);
        phoneNo = findViewById(R.id.mobNo);
    ...
    private void enterAmount() {
        ...
        View mView = getLayoutInflater().inflate(R.layout.entry_box, null);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mAmount.getText().toString().isEmpty()) {
                    ...
                    Intent intent = new Intent(UserData.this, SendToOthers.class);
