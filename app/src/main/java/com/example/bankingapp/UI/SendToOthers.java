...
import com.example.bankingapp.UI.TransferDeclare.TransactionEntry;

public class SendToOthers extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    // RecyclerView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.send_to_other);
    ...
    public void onUserClick(int position) {
        ...
        new TransferHelper(this).insertTransferData(fromUserAccountName, toUserAccountName, transferAmount, 1);
        Toast.makeText(this, "Transaction Successful!!", Toast.LENGTH_LONG).show();

        startActivity(new Intent(SendToOthers.this, MainActivity.class));
        finish();
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitButton = new AlertDialog.Builder(SendToOthers.this);
        builder_exitButton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton ("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick (DialogInterface dialogInterface, int i) {
                        // Transactions Cancelled
                        TransferHelper dbHelper = new TransferHelper(getApplicationContext());
                        ...
                        Toast.makeText(SendToOthers.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(SendToOthers.this, UsersList.class));
                        finish();
                    }
    ...
    private void displayDatabaseInfo() {
        ...
        String[] projection = {
                ...
                UserEntry.COLUMN_ACCOUNT_BALANCE,
                UserEntry.COLUMN_ACCOUNT_NUMBER,
                UserEntry.COLUMN_PHONE_NO,
                UserEntry.COLUMN_USER_EMAIL,
                UserEntry.COLUMN_IFSC_CODE,
        };
        ...
        try {
            ...
            int phoneNoColumnIndex = cursor.getColumnIndex(UserEntry.COLUMN_PHONE_NO);
            int emailColumnIndex = cursor.getColumnIndex(UserEntry.COLUMN_USER_EMAIL);
            int ifscCodeColumnIndex = cursor.getColumnIndex(UserEntry.COLUMN_IFSC_CODE);
            int accountNumberColumnIndex = cursor.getColumnIndex(UserEntry.COLUMN_ACCOUNT_NUMBER);
            int nameColumnIndex = cursor.getColumnIndex(UserEntry.COLUMN_USER_NAME);
            int accountBalanceColumnIndex = cursor.getColumnIndex(UserEntry.COLUMN_ACCOUNT_BALANCE);
